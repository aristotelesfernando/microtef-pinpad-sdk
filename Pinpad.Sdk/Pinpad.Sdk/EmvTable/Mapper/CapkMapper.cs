...
namespace Pinpad.Sdk.EmvTable.Mapper
{
    ...
    {
        /// <summary>
        /// Translates a <see cref="Pinpad.Sdk.EmvTable.Entry.CapkEntry">CapkEntry</see> into a <see cref="PinPadSDK.Controllers.Tables.CapkTable">legacy instance of CapkEntry</see>.
        /// </summary>
        /// <param name="capk"><see cref="Pinpad.Sdk.EmvTable.Entry.CapkEntry">CapkEntry</see> instance.</param>
        /// <returns>A <see cref="PinPadSDK.Controllers.Tables.CapkTable">legacy instance of CapkEntry</see>.</returns>
        ...
        /// <summary>
        /// Translates a <see cref="PinPadSDK.Controllers.Tables.CapkTable">legacy instance of CapkEntry</see> into a <see cref="Pinpad.Sdk.EmvTable.Entry.CapkEntry">CapkEntry</see>.
        /// </summary>
        /// <param name="capk">A <see cref="PinPadSDK.Controllers.Tables.CapkTable">legacy instance of CapkEntry</see>.</param>
