...
namespace PinPadSDK.Commands {
    ...
    public class FncResponse : BaseResponse {
        ...
        public FncResponse() {
            ...
            this.FNC_DECISION = new PinPadFixedLengthPropertyController<OnlineTransactionStatus>("FNC_DECISION", 1, false, DefaultStringFormatter.EnumStringFormatter<OnlineTransactionStatus>, DefaultStringParser.EnumStringParser<OnlineTransactionStatus>);
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<OnlineTransactionStatus> FNC_DECISION { get; private set; }
