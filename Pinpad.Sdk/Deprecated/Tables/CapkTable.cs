...
namespace PinPadSDK.Controllers.Tables {
    ...
    public class CapkTable : BaseTable {
        ...
        /// </summary>
        public CapkTable() {
            this.T2_RID = new PinPadFixedLengthPropertyController<HexadecimalData>("T2_RID", 10, false, DefaultStringFormatter.HexadecimalStringFormatter, DefaultStringParser.HexadecimalStringParser);
            this.T2_CAPKIDX = new PinPadFixedLengthPropertyController<HexadecimalData>("T2_CAPKIDX", 2, false, DefaultStringFormatter.HexadecimalStringFormatter, DefaultStringParser.HexadecimalStringParser);
            this.T2_RUF1 = new PinPadFixedLengthPropertyController<int?>("T2_RUF1", 2, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser, null, 0);
            ...
            this.T2_CHECKSUM = new PinPadFixedLengthPropertyController<HexadecimalData>("T2_CHECKSUM", 40, false, DefaultStringFormatter.HexadecimalStringFormatter, DefaultStringParser.HexadecimalStringParser);
            this.T2_RUF2 = new PinPadFixedLengthPropertyController<HexadecimalData>("T2_RUF2", 42, false, DefaultStringFormatter.HexadecimalStringFormatter, DefaultStringParser.HexadecimalStringParser, null, new HexadecimalData(new byte[0]));
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<HexadecimalData> T2_RID { get; private set; }

        /// <summary>
        /// Certification Authority Public Key Index
        /// </summary>
        public PinPadFixedLengthPropertyController<HexadecimalData> T2_CAPKIDX { get; private set; }

        /// <summary>
        /// Reserved for future use, default 0.
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> T2_RUF1 { get; private set; }
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<HexadecimalData> T2_CHECKSUM { get; private set; }

        /// <summary>
        /// Reserved for future use, default 0.
        /// </summary>
        public PinPadFixedLengthPropertyController<HexadecimalData> T2_RUF2 { get; private set; }
    }
}
