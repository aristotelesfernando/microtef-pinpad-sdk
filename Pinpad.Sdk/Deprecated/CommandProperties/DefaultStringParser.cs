...
namespace PinPadSDK.Property {
    ...
    /// </summary>
    internal class DefaultStringParser {
        /// <summary>
        ...
        internal static Nullable<long> LongIntegerStringParser(StringReader reader, int length) {
        ...
        internal static Nullable<int> IntegerStringParser(StringReader reader, int length) {
        ...
        internal static HexadecimalData HexadecimalStringParser(StringReader reader, int length) {
        ...
        /// <param name="length">string length</param>
        /// <returns>HexadecimalDataController</returns>
        internal static HexadecimalData HexadecimalRightPaddingStringParser(StringReader reader, int length) {
            string data = reader.ReadString(length);
        ...
        internal static Nullable<bool> BooleanStringParser(StringReader reader) {
        ...
        internal static string StringStringParser(StringReader reader) {
        ...
        /// <param name="length">string length</param>
        /// <returns>string</returns>
        internal static string StringStringParser(StringReader reader, int length) {
        ...
        internal static Nullable<char> CharStringParser(StringReader reader) {
        ...
        internal static Nullable<DateTime> DateStringParser(StringReader reader) {
        ...
        /// <param name="reader">string reader</param>
        /// <returns>DateTime</returns>
        internal static Nullable<DateTime> TimeStringParser(StringReader reader) {
            string substring = reader.ReadString(6);
            if (substring == "000000") {
                return null;
            }
        ...
        /// <param name="reader">string reader</param>
        /// <returns>DateTime</returns>
        internal static Nullable<DateTime> DateTimeStringParser(StringReader reader) {
        ...
        internal static enumType EnumStringParser<enumType>(StringReader reader, int length) where enumType : struct {
        ...
        internal static propertyControllerType PropertyControllerStringParser<propertyControllerType>(StringReader reader, int length) where propertyControllerType : BaseProperty, new() {
