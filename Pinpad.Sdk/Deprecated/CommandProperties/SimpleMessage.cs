...
namespace PinPadSDK.Property {
    ...
    /// </summary>
    internal class SimpleMessage : BaseProperty {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        internal SimpleMessage(string fullValue, PaddingType padding = PaddingType.Undefined)
            : this() {
        ...
        internal SimpleMessage(string firstLine, string secondLine, PaddingType padding = PaddingType.Center)
            : this( ) {
                this.Padding = padding;
        ...
        internal static SimpleMessage StringParser(StringReader reader)
        {
