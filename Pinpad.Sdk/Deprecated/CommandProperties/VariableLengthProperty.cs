...
namespace PinPadSDK.Property {
    ...
    /// </summary>
    internal class VariableLengthProperty<type> : SimpleProperty<type> {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        internal VariableLengthProperty(string name,
            int headerLength,
            int maxLength,
            float lengthRatio,
            bool isPadded,
