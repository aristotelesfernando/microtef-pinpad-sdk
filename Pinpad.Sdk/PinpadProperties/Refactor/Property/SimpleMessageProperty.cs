...
namespace Pinpad.Sdk.PinpadProperties.Refactor.Property
{
	...
	/// </summary>
	public sealed class SimpleMessageProperty : BaseProperty
    {
        // Constants
        /// <summary>
        /// Pinpad line length.
        ...
        /// Message first line.
        /// </summary>
        private FixedLengthProperty<string> firstLine { get; set; }
        /// <summary>
        /// Message second line, if any.
        /// </summary>
        private FixedLengthProperty<string> secondLine { get; set; }
        /// <summary>
        ...
        {
            this.firstLine = new FixedLengthProperty<string>("FirstLine", 16, false, 
                StringFormatter.StringStringFormatter, StringParser.StringStringParser);
            this.secondLine = new FixedLengthProperty<string>("SecondLine", 16, false, 
                StringFormatter.StringStringFormatter, StringParser.StringStringParser);
        ...
        public static SimpleMessageProperty CustomStringParser(StringReader reader)
        {
            ...
            string data = StringParser.StringStringParser(reader, FULL_MESSAGE_LENGTH);

            SimpleMessageProperty value = new SimpleMessageProperty();
