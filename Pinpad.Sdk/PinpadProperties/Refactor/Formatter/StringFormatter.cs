...
namespace Pinpad.Sdk.PinpadProperties.Refactor.Formatter
{
    /// <summary>
	/// Contains commonly used StringFormatters.
	/// </summary>
    internal abstract class StringFormatter
    {
        /// <summary>
        ...
        public static string HexadecimalStringFormatter(HexadecimalData obj, int length)
        {
            ...
            return StringFormatter.HexadecimalStringFormatter(obj).PadLeft(length, '0');
        }
        /// <summary>
        ...
        public static string HexadecimalRightPaddingStringFormatter(HexadecimalData obj, int length)
        {
            ...
            return StringFormatter.HexadecimalStringFormatter(obj).PadRight(length, '0');
        }
        /// <summary>
        ...
        {
            string value = StringFormatter.StringStringFormatter(obj);
        ...
        public static string EnumStringFormatter<enumType>(enumType obj, int length) where enumType : struct
        {
            ...
            return StringFormatter.IntegerStringFormatter((realIntValue - 1), length);
        }
        /// <summary>
        ...
        public static string PropertyControllerStringFormatter(BaseProperty obj, int length)
        {
            ...
            string value = StringFormatter.PropertyControllerStringFormatter(obj);
