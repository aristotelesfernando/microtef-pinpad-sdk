...
namespace PinPadSDK.PinPad {
    ...
    public class PinPadStorage {
        ...
        public PinPadStorage(PinPadFacade pinPad) {
            this.PinPad = pinPad;
            ...
            lock (this.fileNameToPathDictionary) {
                ...
                foreach (string fileName in this.FileNameCollection) {
                    ...
                    if (this.OnFileLoaded != null) {
                        this.OnFileLoaded(this, new PinPadFileLoadedEventArgs(this.PinPad, fileName, filePath, successfullyLoaded, counter, this.fileNameToPathDictionary.Count));
                    }
        ...
        public Nullable<bool> FileExists(string fileName) {
            ...
            LfcResponse response = this.PinPad.Communication.SendRequestAndReceiveResponse<LfcResponse>(request);
