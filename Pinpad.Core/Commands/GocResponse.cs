...
namespace PinPadSDK.Commands {
    ...
    public class GocResponse : BaseResponse {
        ...
        public GocResponse() {
            ...
            this.GOC_DECISION = new PinPadFixedLengthPropertyController<OfflineTransactionStatus>("GOC_DECISION", 1, false, DefaultStringFormatter.EnumStringFormatter<OfflineTransactionStatus>, DefaultStringParser.EnumStringParser<OfflineTransactionStatus>);
            ...
            this.GOC_ERRPINOFF = new PinPadFixedLengthPropertyController<int?>("GOC_ERRPINOFF", 1, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
            ...
            this.GOC_PINBLK = new PinPadFixedLengthPropertyController<HexadecimalData>("GOC_PINBLK", 16, false, DefaultStringFormatter.HexadecimalStringFormatter, DefaultStringParser.HexadecimalStringParser);
            this.GOC_KSN = new PinPadFixedLengthPropertyController<HexadecimalData>("GOC_KSN", 20, false, DefaultStringFormatter.HexadecimalStringFormatter, DefaultStringParser.HexadecimalStringParser);
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<OfflineTransactionStatus> GOC_DECISION { get; private set; }
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> GOC_ERRPINOFF { get; private set; }
        ...
        /// Encrypted Pin Block
        /// </summary>
        public PinPadFixedLengthPropertyController<HexadecimalData> GOC_PINBLK { get; private set; }
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<HexadecimalData> GOC_KSN { get; private set; }
