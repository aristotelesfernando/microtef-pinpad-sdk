...
namespace PinPadSDK.Commands {
    ...
    public class GcrResponse : BaseResponse {
        ...
        public GcrResponse() {
            ...
            this.GCR_CARDTYPE = new PinPadFixedLengthPropertyController<ApplicationType>("GCR_CARDTYPE", 2, false, DefaultStringFormatter.EnumStringFormatter<ApplicationType>, DefaultStringParser.EnumStringParser<ApplicationType>);
            this.GCR_STATCHIP = new PinPadFixedLengthPropertyController<FallbackStatus>("GCR_STATCHIP", 1, false, DefaultStringFormatter.EnumStringFormatter<FallbackStatus>, DefaultStringParser.EnumStringParser<FallbackStatus>);
            this.GCR_APPTYPE = new PinPadFixedLengthPropertyController<int?>("GCR_APPTYPE", 2, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
            this.GCR_ACQIDX = new PinPadFixedLengthPropertyController<int?>("GCR_ACQIDX", 2, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
            this.GCR_RECIDX = new PinPadFixedLengthPropertyController<int?>("GCR_RECIDX", 2, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
            ...
            this.GCR_PANSEQNO = new PinPadFixedLengthPropertyController<int?>("GCR_PANSEQNO", 2, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
            this.GCR_APPLABEL = new PinPadFixedLengthPropertyController<string>("GCR_APPLABEL", 16, false, DefaultStringFormatter.LeftPaddingWithSpacesStringFormatter, DefaultStringParser.StringStringParser);
            ...
            this.GCR_CHNAME = new PinPadFixedLengthPropertyController<string>("GCR_CHNAME", 26, false, DefaultStringFormatter.LeftPaddingWithSpacesStringFormatter, DefaultStringParser.StringStringParser);
            ...
            this.GCR_RUF1 = new PinPadFixedLengthPropertyController<string>("GCR_RUF1", 29, false, DefaultStringFormatter.LeftPaddingWithSpacesStringFormatter, DefaultStringParser.StringStringParser, null, String.Empty.PadLeft(29));
            this.GCR_ISSCNTRY = new PinPadFixedLengthPropertyController<int?>("GCR_ISSCNTRY", 3, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<ApplicationType> GCR_CARDTYPE { get; private set; }
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<FallbackStatus> GCR_STATCHIP { get; private set; }

        /// <summary>
        /// AID table selected registry's Application Type
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> GCR_APPTYPE{ get; private set; }

        /// <summary>
        /// AID table selected registry's Acquirer Index
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> GCR_ACQIDX { get; private set; }

        /// <summary>
        /// AID table selected registry's Record Index
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> GCR_RECIDX{ get; private set; }
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> GCR_PANSEQNO { get; private set; }

        /// <summary>
        /// Card Application Label, left aligned
        /// </summary>
        public PinPadFixedLengthPropertyController<string> GCR_APPLABEL { get; private set; }
        ...
        /// Cardholder name
        /// </summary>
        public PinPadFixedLengthPropertyController<string> GCR_CHNAME { get; private set; }
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<string> GCR_RUF1 { get; private set; }

        /// <summary>
        /// Card Issuer Country Code
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> GCR_ISSCNTRY { get; private set; }
