...
namespace PinPadSDK.Commands {
    ...
    public class FncRequest : BaseCommand {
        ...
        public FncRequest() {
            ...
            this.FNC_COMMST = new PinPadFixedLengthPropertyController<AcquirerCommunicationStatus>("FNC_COMMST", 1, false, DefaultStringFormatter.EnumStringFormatter<AcquirerCommunicationStatus>, DefaultStringParser.EnumStringParser<AcquirerCommunicationStatus>);
            this.FNC_ISSMODE = new PinPadFixedLengthPropertyController<int?>("FNC_ISSMODE", 1, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser, null, 0);
            this.FNC_ARC = new PinPadFixedLengthPropertyController<string>("FNC_ARC", 2, false, DefaultStringFormatter.StringStringFormatter, DefaultStringParser.StringStringParser);
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<AcquirerCommunicationStatus> FNC_COMMST { get; private set; }

        /// <summary>
        /// Card Issuer Type, fixed 0
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> FNC_ISSMODE { get; private set; }

        /// <summary>
        /// Authorization Response Code
        /// </summary>
        public PinPadFixedLengthPropertyController<string> FNC_ARC { get; private set; }
