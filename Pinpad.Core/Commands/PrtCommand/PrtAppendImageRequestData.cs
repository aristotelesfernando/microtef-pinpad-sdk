...
namespace Pinpad.Core.Commands
{
	...
	public class PrtAppendImageRequestData : BasePrtRequestData
	{
		...
		{
			this.PRT_PADDING = new PinpadFixedLengthProperty<Nullable<int>>("PRT_PADDING", 4, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
