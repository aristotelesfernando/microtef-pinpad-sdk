...
namespace PinPadSDK.Commands.Stone {
    ...
    public class SecRequest : BaseStoneRequest {
        ...
        public SecRequest() {
            ...
            this.SEC_ACQIDX = new PinPadFixedLengthPropertyController<int?>("SEC_ACQIDX", 2, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
        ...
        /// </summary>
        public PinPadFixedLengthPropertyController<Nullable<int>> SEC_ACQIDX { get; private set; }
