...
namespace Pinpad.Core.Commands {
	...
	public class TliRequest : BaseCommand {
		...
		public TliRequest() {
			...
			this.TLI_ACQIDX = new PinpadFixedLengthProperty<int?>("TLI_ACQIDX", 2, false, DefaultStringFormatter.IntegerStringFormatter, DefaultStringParser.IntegerStringParser);
